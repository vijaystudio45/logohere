  ...
  return (
    <div>
      <section className="center-section">
        <div className="">
          <p className="socialdescription secvice text-center">Blog</p>
          <h2 className="mostpopularheading frequently md:mb-0 mb-6">Our Blogs</h2>

          <section class="text-gray-600 body-font">
            <div class="container px-5 md:pt-24 mx-auto">
                ...
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img
                      ...
                      alt="blog"
                    />
                    <div class="p-6 bg-[#3700b3] text-white">
